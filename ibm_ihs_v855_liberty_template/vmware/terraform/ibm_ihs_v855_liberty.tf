...
# This is a terraform generated template generated from ibm_ihs_v855_liberty_template
...
variable "IHSLibertyV855Node01_folder" {
  description = "Target vSphere folder for virtual machine"
}

variable "IHSLibertyV855Node01_datacenter" {
...
variable "IHSLibertyV855Node01_network_interface_label" {
  description = "vSphere port group or network label for virtual machine's vNIC"
}

variable "IHSLibertyV855Node01_ipv4_gateway" {
  description = "IPv4 gateway for vNIC configuration"
}

variable "IHSLibertyV855Node01_ipv4_address" {
  description = "IPv4 address for vNIC configuration"
}

variable "IHSLibertyV855Node01_ipv4_prefix_length" {
  description = "IPv4 Prefix length for vNIC configuration, which is required to be numbers between 8 and 32"
}

variable "IHSLibertyV855Node01_root_disk_datastore" {
...
#########################################################
##### Resource : IHSLibertyV855Node01_chef_bootstrap_comp
#########################################################
  ...
  data = <<EOT
{
  ...
  "host_ip": "${vsphere_virtual_machine.IHSLibertyV855Node01.network_interface.0.ipv4_address}",
  "node_name": "${var.IHSLibertyV855Node01-name}",
  "node_attributes": {
    "ibm_internal": {
      "stack_id": "${random_id.stack_id.hex}",
  ...
  data = <<EOT
{
  ...
  "node_attributes": {
    ...
    "ihs": {
      ...
      "install_dir": "${var.IHSLibertyV855Node01_ihs_install_dir}",
      "install_mode": "${var.IHSLibertyV855Node01_ihs_install_mode}",
      "java": {
        "legacy": "${var.IHSLibertyV855Node01_ihs_java_legacy}",
        "version": "${var.IHSLibertyV855Node01_ihs_java_version}"
      },
      "os_users": {
        "ihs": {
          "gid": "${var.IHSLibertyV855Node01_ihs_os_users_ihs_gid}",
          "name": "${var.IHSLibertyV855Node01_ihs_os_users_ihs_name}",
          "shell": "${var.IHSLibertyV855Node01_ihs_os_users_ihs_shell}"
        }
      },
      "plugin": {
        "enabled": "true",
        "install_dir": "${var.IHSLibertyV855Node01_ihs_plugin_install_dir}",
        "was_webserver_name": "${var.IHSLibertyV855Node01_ihs_plugin_was_webserver_name}"
      },
      "port": "${var.IHSLibertyV855Node01_ihs_port}",
      "version": "${var.IHSLibertyV855Node01_ihs_version}"
    }
  },
  "vault_content": {
    "item": "secrets",
...
output "IHSLibertyV855Node01_ip" {
  value = "VM IP Address : ${vsphere_virtual_machine.IHSLibertyV855Node01.network_interface.0.ipv4_address}"
}

output "IHSLibertyV855Node01_name" {
  value = "${var.IHSLibertyV855Node01-name}"
}

output "IHSLibertyV855Node01_roles" {
