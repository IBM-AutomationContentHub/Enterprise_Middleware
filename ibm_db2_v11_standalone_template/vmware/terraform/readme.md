...
This template deploys a standalone instance of IBM DB2 Enterprise Server Edition 11.1 on a Linux virtual machine. IBM DB2 is installed and configured with a single instance and database created.<br>
