...
This template deploys Apache HTTP Server with a full configuration on a single Linux node. The template includes virtual host configuration and enables SSL support.<br>
