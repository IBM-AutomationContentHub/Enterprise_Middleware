...
This template deploys IBM DB2 Enterprise Server Edition 11.1 on a Linux virtual machine. IBM DB2 is installed and configured with a single instance and database created. The DB2 instance, database data, logs and archive stored in separate partitions.<br>
