...
This template deploys IBM DB2 Enterprise Server Edition 10.5 on a Linux virtual machine. IBM DB2 is installed and configured with multiple instances and databases created.<br>
