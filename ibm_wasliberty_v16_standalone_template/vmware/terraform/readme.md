...
<table>
  <tr>
    <th>user</th>
    <th>The user name for vSphere API operations.</th>
  </tr>
  <tr>
    <td>password</code></td>
    <th>The user password for vSphere API operations.</th>
  </tr>
  <tr>
    <td>vsphere_server</code></td>
    <th>The vSphere Server name for vSphere API operations.</th>
  </tr>
  <tr>
    <td>allow_unverified_ssl</code></td>
    <th>Set True, VMware vSphere client will permit unverifiable SSL certificates.</th>
  </tr>
</table>
