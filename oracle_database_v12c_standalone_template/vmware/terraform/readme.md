...
This template deploys Oracle Enterprise Database V12c on a Linux virtual machine.<br>Oracle DB is installed and configured with a single raw database created.<br>
...
Oracle Enterprise Database V12c<br>
<br>
### Default Virtual Machine Settings

 vCPU = 4, Memory = 8GB, Storage = 25GB<br>
<br>
