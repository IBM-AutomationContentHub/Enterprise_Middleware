...
This template deploys a WebSphere Application Server Network Deployment 8.5.5 cell with an integrated IBM HTTP Server. Four Linux virtual machine instances are used to host the Deployment Manager, two Custom Nodes and IBM HTTP Sever.<br>
...
IBM HTTP Server for WebSphere Application Server 8.5.5<br>
Web Server Plug-ins for IBM WebSphere Application Server 8.5.5<br>
