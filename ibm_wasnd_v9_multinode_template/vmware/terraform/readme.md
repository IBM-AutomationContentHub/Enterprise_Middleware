...
This template deploys a WebSphere Application Server Network Deployment 9 cell with an integrated IBM HTTP Server. Four Linux virtual machine instances are used to host the Deployment Manager, two Custom Nodes and IBM HTTP Sever.<br>
